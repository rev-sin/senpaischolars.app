...
-- CreateTable
CREATE TABLE "public"."PasswordFailedAttempt" (
    "id" UUID NOT NULL,
    "userId" UUID NOT NULL,
    "failedAt" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "PasswordFailedAttempt_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."PasswordFailedAttempt" ADD CONSTRAINT "PasswordFailedAttempt_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
